		...
		<form:form  modelAttribute="newItem" class="form-horizontal" >
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="id"><spring:message code="addItem.form.itemId.label"/></label>
					<div class="col-lg-10">
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="initialPrice"><spring:message code="addItem.form.price.label"/></label>
					<div class="col-lg-10">
